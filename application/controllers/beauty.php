	...
	public function _category_tenant($t_category)
	{
		...
		{	
			...
			{		
				...
				$tenant_detail[$count]['cmsdir_name'] = stripslashes(utf8_decode($this->stripslashes_deep($row->cmsdir_name)));
	...
	public function _tenant_detail($t_id)
	{
		...
		{	
			...
			{		
				...
				$tenant_detail['cmsdir_name'] = stripslashes(utf8_decode($this->stripslashes_deep($row->cmsdir_name)));
...
/* End of file beauty.php */
/* Location: ./application/controllers/beauty.php */